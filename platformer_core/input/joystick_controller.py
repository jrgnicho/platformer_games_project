...
from platformer_core.input import ControllerInterface
from platformer_core.input import JoystickButtons
from platformer_core.input import JoystickState
...
class JoystickController(ControllerInterface):
  ...
  #                        interface (keys) and the constants defined in the platformer_core.input.JoystickButtons class (values).
  #  @param joystick_obj  The joystick interface.  Make sure that the pygame.joystick.init() method has been invoked
  #  @param joystick_axes  A platformer_core.input.JoystickAxes object for detection the direction of the D-pad
  ...
  def __init__(self,button_map,joystick_obj,joystick_axes,buffer_timeout = DEFAULT_BUFFER_TIMEOUT,merge_time = DEFAULT_MERGE_TIME):
    ...
    self.button_map_ = button_map            # Dictionary containing the mapping of the device button index (key) in the 
                                                ...
                                                # platformer_core.input.JoystickButtons class
